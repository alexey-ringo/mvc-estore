...
class Router {
    ...
    public function run() {
        ...
        */
        ...
        //Вывести наличие всех предустанолвенных запросов из routes.php
        foreach($this->routes as $uriPattern => $path) {
            //Для каждого маршрута в $uriPattern помещаем строку запроса из routes.php
            //Для каждого маршрута в $path помещаем строку пути к контроллеру и action из routes.php
            ...
            if(preg_match("~$uriPattern~", $uri)) {
                ...
                //echo '<br><br>Нужно сформировать (внетренний путь): ' . $internalRouter;
